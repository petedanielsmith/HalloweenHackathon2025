...
![Site view across device1](static/images/page-full.png)
![Site view across device2](static/images/page-tablet.png)
![Site view across device3](static/images/page-phone.png)
...
![Favicon](static/images/icons8-scream-128.png)
...
![satifiedcustomer1](static/images/deomon1.png)
![satifiedcustomer2](static/images/deomon2.png)
![satifiedcustomer3](static/images/deomon3.png)
![satifiedcustomer4](static/images/deomon4.png)
![satifiedcustomer5](static/images/deomon5.png)
![satifiedcustomer6](static/images/deomon6.png)

#### images around the site

We have generated or created different images to help us in different features.

 This image is used to display our prices on the events ![ghost](static/images/ghost.png).
 
 The Following are used as images for our different categories of events
 ![events1](static/images/haunted-house.png).
 ![events2](static/images/possession.png).
 ![events3](static/images/trip-away.png).

 This image is for our Trick or Treat game.
 ![trickortreat](static/images/trick-face-overlay.jpg).

#### About Page

The following images are the profile pictures for the staff of the site.
 ![undead1](static/images/undead1.png).
 ![undead2](static/images/undead2.png).
 ![undead3](static/images/undead3.png).
 ![undead4](static/images/undead4.png).
 ![undead5](static/images/undead5.png).
 ![undead6](static/images/undead6.png).
 ![undead7](static/images/undead7.png).
 ![undead8](static/images/undead8.png).
...
![Home page](static/images/page-full.png)

#### Trick or Treat Game:

![Game](static/images/trickortreat.png)

#### Event Categories:

![events](static/images/events-cat.png)
![pagination](static/images/events-pag.png)
